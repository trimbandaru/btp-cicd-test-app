		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CI CD Test",
									"targetURL": "#comdemocicdtest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdemocicdtest-display": {
								"semanticObject": "comdemocicdtest",
								"action": "display",
								"description": "for testing cicd pipelines",
								"title": "CI CD Test",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.demo.cicdtest",
									"url": sap.ui.require.toUrl("com/demo/cicdtest")
								}
							}
						}
					}
